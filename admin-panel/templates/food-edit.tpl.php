            ...
            <div class="form">
                <div class="fields">
                        ...
                        <div class="select">
                            ...
                            <select id="menu_id" name="menu_id" onchange="if (this.value != '') location.href='<?php echo 'http://'.$_SERVER['HTTP_HOST'] . $this->action;?>?mid='+this.value">
								...
								<?php foreach($this->menu_list as $mkey=>$mval){
									?><option value="<?php echo $mval['id'];?>" <?php echo (!empty($this->err) && $this->menu_id == $mval['id'] ? 'selected' : (!empty($this->mid) && $this->mid == $mval['id'] ? 'selected' : (isset($this->food_info['menu_id']) && $this->food_info['menu_id'] == $mval['id'] ? 'selected' : '')));?>><?php echo $mval['title'];?></option><?php
								}//end foeach?>
                            </select>
                            <?php }//end if?>
                        </div>
                        ...
                        <div class="select">                            
                            <select id="category_id" name="category_id">
								...
								<?php foreach($this->categories_list as $ckey=>$cval){
									?><option value="<?php echo $cval['id'];?>" <?php echo (!empty($this->err) && $this->category_id == $cval['id'] ? 'selected' : (isset($this->food_info['category_id']) && $this->food_info['category_id'] == $cval['id'] ? 'selected' : ''));?>><?php echo $cval['title'];?></option><?php
								}//end foeach?>
                            	<?php }//end if?>
                            </select>
                        </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input">
                            <input type="text" class="inputText" name="title" value="<?php echo (!empty($this->err) ? $this->title : (isset($this->food_info['title']) ? $this->food_info['title'] : ''));?>" />
                            <span class="star">*</span>
                        </div>
                    </div>
                    <?php if (!empty($this->food_info['image_file'])) {?>
                    <div class="field">
                        <div class="label"></div>
                        <div class="input">
                            <img src="<?php echo $this->image_path . $this->food_info['image_file'];?>" alt="<?php echo $this->food_info['title'];?>" />
                        </div>
                    </div>
                    <?php }?>
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <div class="textarea">
                            <textarea id="short_description" name="short_description" class="inputRichArea" cols="50" rows="15"><?php echo (!empty($this->err) ? $this->short_description : (isset($this->food_info['short_description']) ? $this->food_info['short_description'] : ''));?></textarea>
                        </div>
                    </div>
                    <div class="field">
                        <div class="label">
                        ...
                        <div class="input">
                            <span>Tk. </span><input type="text" class="inputText" name="price" value="<?php echo (!empty($this->err) ? $this->price : (isset($this->food_info['price']) ? $this->food_info['price'] : ''));?>" />
                            <span class="star">*</span>
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="input">
                            <input type="text" class="inputText" name="sequence" value="<?php echo (!empty($this->err) ? $this->sequence : (isset($this->food_info['sequence']) ? $this->food_info['sequence'] : ''));?>" />
                        </div>
                    </div>
                    <div class="buttons">
